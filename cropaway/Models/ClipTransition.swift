...
final class ClipTransition: Identifiable, ObservableObject, Codable {
    ...
    /// Type of transition (cut or optical flow morph)
    @Published var type: TransitionType

    /// Duration of the transition in seconds (only used for opticalFlow)
    ...
    /// Effective duration of this transition (0 for cuts)
